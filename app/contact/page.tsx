    ...
    <main className="bg-cucumber-700 text-white">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16 grid md:grid-cols-3 gap-10">
        <div className="md:col-span-1">
          ...
          {/* React form → AJAX submit */}
          <form name="contact" method="POST" onSubmit={handleSubmit} className="mt-6 space-y-3">
            ...
            >
              {submitting ? "Sending…" : "SIGN UP / SEND"}
            </button>
